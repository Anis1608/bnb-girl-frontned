    ...
    <section className="series-section">
      ...
      <div className="series-wrapper">
        ...
        <div className="series-scroll" id="seriesScroll" ref={scrollRef}>
          {/* Card 1: STEM */}
          <a className="series-card series-card--stem reveal visible" href="https://www.youtube.com/@BoldandBrilliantgirl" target="_blank" rel="noopener noreferrer">
            ...
            <div className="series-card__content">
              <p className="series-card__badge">8 Episodes</p>
              <h3 className="series-card__title">Women in STEM</h3>
              <div className="series-card__bar-wrap">
                <div className="series-card__bar-fill" style={{ width: '25%' }}></div>
              </div>
          ...
          <a className="series-card series-card--entrepreneurship reveal visible" href="https://www.youtube.com/@BoldandBrilliantgirl" target="_blank" rel="noopener noreferrer">
            <div className="series-card__bg"></div>
            <svg className="series-card__art" viewBox="0 0 256 360" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="series-card__icon">🚀</div>
            <div className="series-card__content">
              <p className="series-card__badge">6 Episodes</p>
              <h3 className="series-card__title">Entrepreneurship Diaries</h3>
              <div className="series-card__bar-wrap">
                <div className="series-card__bar-fill" style={{ width: '0%' }}></div>
              </div>
              <button className="series-card__btn">Watch on YouTube →</button>
            </div>
          </a>
          ...
          <a className="series-card series-card--mental-health reveal visible" href="https://www.youtube.com/@BoldandBrilliantgirl" target="_blank" rel="noopener noreferrer">
            <div className="series-card__bg"></div>
            <svg className="series-card__art" viewBox="0 0 256 360" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="series-card__icon">🌸</div>
            <div className="series-card__content">
              <p className="series-card__badge">4 Episodes</p>
              <h3 className="series-card__title">Mental Health &amp; Career</h3>
              <div className="series-card__bar-wrap">
                <div className="series-card__bar-fill" style={{ width: '50%' }}></div>
              </div>
              <button className="series-card__btn">Watch on YouTube →</button>
            </div>
          </a>
          ...
          {/* Card 4: Law */}
          <a className="series-card series-card--law reveal visible" href="https://www.youtube.com/@BoldandBrilliantgirl" target="_blank" rel="noopener noreferrer">
            <div className="series-card__bg"></div>
            <svg className="series-card__art" viewBox="0 0 256 360" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="series-card__icon">⚖️</div>
            <div className="series-card__content">
              <p className="series-card__badge">5 Episodes</p>
              <h3 className="series-card__title">Breaking Barriers in Law</h3>
              <div className="series-card__bar-wrap">
                <div className="series-card__bar-fill" style={{ width: '0%' }}></div>
              </div>
              <button className="series-card__btn">Watch on YouTube →</button>
          ...
          {/* Card 5: Creative */}
          <a className="series-card series-card--creative reveal visible" href="https://www.youtube.com/@BoldandBrilliantgirl" target="_blank" rel="noopener noreferrer">
            <div className="series-card__bg"></div>
            <svg className="series-card__art" viewBox="0 0 256 360" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="series-card__icon">🎨</div>
            <div className="series-card__content">
              <p className="series-card__badge">7 Episodes</p>
              <h3 className="series-card__title">The Creative Career</h3>
              <div className="series-card__bar-wrap">
                <div className="series-card__bar-fill" style={{ width: '14%' }}></div>
              </div>
              <button className="series-card__btn">Watch on YouTube →</button>
            </div>
          </a>
          ...
          {/* Card 6: Finance */}
          <a className="series-card series-card--finance reveal visible" href="https://www.youtube.com/@BoldandBrilliantgirl" target="_blank" rel="noopener noreferrer">
            <div className="series-card__bg"></div>
            <svg className="series-card__art" viewBox="0 0 256 360" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="series-card__content">
              <p className="series-card__badge">5 Episodes</p>
              <h3 className="series-card__title">Corporate &amp; Finance</h3>
              <div className="series-card__bar-wrap">
                <div className="series-card__bar-fill" style={{ width: '0%' }}></div>
              </div>
              <button className="series-card__btn">Watch on YouTube →</button>
